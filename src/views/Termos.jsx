function Termos(){
    return(
        ...
        <h2><strong>Termos e condições de uso</strong></h2>
<p> </p>
<p>Seja bem-vindo ao nosso site. Leia com muita atenção todos os termos abaixo.</p>
<p> </p>
<p>Este documento, e todo o conteúdo do site é oferecido por <strong>Help Health</strong>, neste termo representado apenas por "EMPRESA", que regulamenta todos os direitos e obrigações com todos que acessam o site, denominado neste termo como "VISITANTE", reguardado todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo, situado no endereço <strong>.</strong></p>
<p> </p>
